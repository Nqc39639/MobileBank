...
<div class="layuimini-main">
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <button class="layui-btn layui-btn-sm layui-btn-danger data-delete-btn" lay-event="delete">恢复</button>
        </div>
    </script>
    ...
    <script type="text/html" id="barDemo">
        <div class="layui-clear-space">
            ...
            <a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="delete">恢复</a>
        </div>
    </script>
</div>
...
<script>
    layui.use(["table", "layer", "jquery", "form"], function () {
        ...
        table.render({
            ...
            toolbar: '#toolbarDemo',
            url: '<%=basePath%>/admin/readerAbnormalUser',
            method: "post"
        })
            ...
            if (obj.event === 'delete') {   //监听删除操作
                ...
                if (data.length === 0) {
                    ...
                    layer.confirm('您确定要恢复吗？', function (index) {
                        $.ajax({
                            url: "<%=basePath%>/admin/returnNormalUserInfo",
                            type: "post",

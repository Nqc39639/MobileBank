            ...
            <ul class="layui-nav layui-layout-right">
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:" data-refresh="刷新">
                        <i title="点击刷新" class="fa fa-refresh">&nbsp刷新页面</i></a>
                </li>
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:" data-clear="清理" class="layuimini-clear">
                        <i title="点击清理" class="fa fa-trash-o">&nbsp清理缓存</i></a>
                </li>
                <li class="layui-nav-item layuimini-setting">
                    <a>${sessionScope.adminInfo.account}</a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:" layuimini-content-href="<%=basePath%>/admin/adminInfoSettingPage"
                               data-title="个人资料" data-icon="fa fa-gears">个人资料<span class="layui-badge-dot"></span></a>
                        </dd>
                        <dd>
                            <a href="javascript:" layuimini-content-href="<%=basePath%>/admin/updateAdminPasswordPage"
                ...
                <li class="layui-nav-item layuimini-select-bgcolor" lay-unselect>
                    <a href="javascript:" data-bgcolor="配色方案"><i title="更多" class="fa fa-ellipsis-v"></i></a>
                </li>
            </ul>
        </div>
    </div>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin', 'miniTongji'], function () {
        ...
        $('.login-out').on("click", function () {
            layer.msg('退出登录成功！', {icon: 6}, function () {
